...
% ll = 1/2*trace(params.Q\(map(:,2:end)*map(:,2:end)')) ...
%     - 1/2*trace(params.Q\(map(:,2:end)*(params.A*map(:,1:end-1))')) ...
%     - 1/2*trace(params.Q\((params.A*map(:,1:end-1))*map(:,2:end)')) ...
%     + 1/2*trace(params.Q\((params.A*map(:,1:end-1))*(params.A*map(:,1:end-1))')) ...
...
% grad = [zeros(size(map,1),1),params.Q\map(:,2:end)] ...
%        + [params.A'*(params.Q\params.A)*map(:,1:end-1),zeros(size(map,1),1)] ...
%        + [zeros(size(map,1),1),-params.Q\params.A*map(:,1:end-1)] ...
%        + [-params.A'*(params.Q\map(:,2:end)),zeros(size(map,1),1)]...
%        ;
