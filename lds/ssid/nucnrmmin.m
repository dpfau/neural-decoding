...
%             yh = yh_;
%             yh_ = tfocs_SCD( @(varargin) poiss_loglik( y(:,1:N), s0(1)/l/N/opts.vsig^2, opts.lag, varargin{:} ), ...
...
%                              tfocs_opts );
%         end
        Zh = tfocs( @(varargin) poiss_loglik_conj( y(:,1:N), s0(1)/l/N/opts.vsig^2, opts.lag, varargin{:} ), ...
                    @(varargin) adjoint_hankel_op( Un, l, i, N, opts.lag, varargin{:} ), ...
                    @proj_spectral, ...
                    hankel_op( Un, l, i, N, y(:,1:N), 1 ), tfocs_opts );
    case 'poiss_admm'
